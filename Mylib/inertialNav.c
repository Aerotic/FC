...
/***************Z方向速度和位置 START***************/			
		...
		/*加速度校准量在[-1m/s/s,1/s/s]*/
		z_ef.accz.correction = LIMIT(z_ef.accz.correction,-100,100);
		/*速度校准量*/
		z_ef.velz.correction = (ms5611.baroAlt - z_ef.posz.base)*0.5f;
		/*速度校准量在[-1m/s,1/s]*/
